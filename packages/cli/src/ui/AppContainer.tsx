...
export const AppContainer = React.forwardRef(
  // TODO(b/361158882): Fix this type.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  (props: AppContainerProps, ref: any) => {
    AppContainer.displayName = 'AppContainer';
    const { settings, config, initializationResult, initialState } = props;
    const historyManager = useHistory(initialState?.history);
    ...
    const buffer = useTextBuffer({
      initialText: initialState?.inputText ?? '',
